...
class SnowmanPanel extends JPanel
{
   ...
   public void paintComponent (Graphics page)
   {
      ...
      // moving sun to the upper right corner 
      page.setColor (Color.yellow);
      page.fillOval (200, -40, 80, 80); 
      ...
      page.drawArc (MID-10, TOP+20, 20, 10, 180, -180);// frown
      ...
      page.fillOval (MID-5, MID-30, 5, 5);      // head

      page.setColor(Color.red);
      page.fillOval (MID-5, MID-50, 5, 5); 
